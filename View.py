...
class View:
    def __init__(self, top=None):
        ...
        font13 = "-family {Arial} -size 20 -weight " \
        ...
        self.songName.configure(text='''MUSIC PLAYER''')
        ...
        self._img1 = tk.PhotoImage(file="G:/icons/pause.png")
        ...
        self._img2 = tk.PhotoImage(file="G:/icons/play.png")
        ...
        self._img3 = tk.PhotoImage(file="G:/icons/stop.png")
        ...
        self._img4 = tk.PhotoImage(file="G:/icons/vinylrecord.png")
        ...
        self._img5 = tk.PhotoImage(file="G:/icons/previous.png")
        ...
        self._img6 = tk.PhotoImage(file="G:/icons/add.png")
        ...
        self._img7 = tk.PhotoImage(file="G:/icons/delete.png")
        ...
        self._img8 = tk.PhotoImage(file="G:/icons/like.png")
        ...
        self._img9 = tk.PhotoImage(file="G:/icons/broken-heart.png")
        ...
        self._img10 = tk.PhotoImage(file="G:/icons/refresh.png")
    ...
    def setup_player(self):
        try:
            ...
            messagebox.showerror\
                ("DB Error!",ex)
            self.Button9.configure(state="disabled") #addfavourite=Button9
            self.Button10.configure(state="disabled")#loadfavourite=Button10
            self.Button11.configure(state="disabled")#removefavourite=Button11
        ...
        self.playList.configure(font="Arial 12")
        self.playList.bind("<Double-1>",self.list_double_click)
        img=tk.PhotoImage(file="G:/icons/vinylrecord.png")
        self.top.iconphoto(self.top,img)
        self.top.title("MOUZIKKA - Developed by Mr.SOURABH PATEL")#Dance to the rhythm of your heart!!!
    ...
    def play_song(self):
        ...
        try:
            if len(self.sel_song_index_tuple)==0:
                raise NoSongSelectedError("Plaeze select a song to play")
    ...
    def load_next_song(self):
        try:
            ...
            if self.next_song_index==self.playList.count() and self.playList.count()+1:
    ...
    def remove_song(self):
        ...
        try:
            if len(self.sel_index_tuple)==0:
                raise NoSongSelectedError("Pleaze select a song to remove!")
    ...
    def close_window(self):
        ...
        if(result):
            ...
            messagebox.showinfo("Have a good day!","Thankyou for using Mouzikka app!")
            self.top.destroy()
